...
export const QUIZ: QuizStep[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'speed', label: 'Speed and Baserunning' },
  ...
  },
  {
    ...
    label: 'Equipment',
    options: [
      { value: 'none', label: 'Just open space', hint: 'No gear needed' },
      { value: 'ball', label: 'A ball and a glove' },
      { value: 'tee', label: 'A tee, bat and net' },
