...
// Diamondcraft has never shipped, so its keys carry its own name rather than
// the ones inherited when this project was copied from Court Craft.

import AsyncStorage from '@react-native-async-storage/async-storage';

export const KEYS = {
  profile: 'diamondcraft:profile',
  log: 'diamondcraft:log',
  cycle: 'diamondcraft:cycle',
  drillTicks: 'diamondcraft:drillticks',
  results: 'diamondcraft:results',
  banked: 'diamondcraft:banked',
  accepted: 'diamondcraft:accepted',
  entitlement: 'diamondcraft:entitlement',
  agreement: 'diamondcraft:agreement',
} as const;
...
const WORKOUTS_KEY = 'diamondcraft:workouts';
