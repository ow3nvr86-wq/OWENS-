...
export const QUIZ: QuizStep[] = [
  ...
  },
  {
    ...
    label: 'Level',
    options: [
      { value: 'youth', label: 'Youth club', hint: '12 and under' },
  ...
  },
  {
    ...
    options: [
      { value: 'passing', label: 'Passing and Serve Receive' },
      { value: 'setting', label: 'Setting' },
      { value: 'hitting', label: 'Hitting' },
      { value: 'serving', label: 'Serving' },
      { value: 'blocking', label: 'Blocking' },
      { value: 'defense', label: 'Digging and Defense' },
      { value: 'jumping', label: 'Jumping and Athleticism' },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'ball', label: 'A ball and space' },
      { value: 'wall', label: 'A ball and a wall', hint: 'Garage or gym wall' },
      { value: 'net', label: 'A net and a court' },
