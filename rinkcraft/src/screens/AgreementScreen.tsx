...
const POINTS = [
  ...
  'I understand that Rinkcraft is a general training guide, that it cannot see me or assess me, and that nothing in it is medical advice or personal coaching.',
