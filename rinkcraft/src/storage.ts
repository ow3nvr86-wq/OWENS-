...
// Rinkcraft has never shipped, so its keys carry its own name rather than
...
export const KEYS = {
  ...
  log: 'rinkcraft:log',
  cycle: 'rinkcraft:cycle',
  drillTicks: 'rinkcraft:drillticks',
  results: 'rinkcraft:results',
  banked: 'rinkcraft:banked',
  accepted: 'rinkcraft:accepted',
  entitlement: 'rinkcraft:entitlement',
  agreement: 'rinkcraft:agreement',
} as const;
